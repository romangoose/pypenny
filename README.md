...
>привлекала идея оперировать суммами вроде `30 экю, 45 пистолей` 
...
Тем не менее, первое, что приходит в голову при взгляде на подобные числа после нескольких операци с ними,
это, все-таки, 
...
при делении смешанного числа на число обычное - получается смешанное число.

Вторая операция должна позволять делить смешанное число на смешанное
и получать в итоге число обычное.
Фактически, ответить на вопрос, **сколько раз** одно смешанное число "помещается" в другом.
...
1. оно смешанное число может быть равным другому, если
    a. все его единицы могут быть приведены к одной единице
    b. численные значения результатов буду равны
...
порядок, в котором задаются единицы, важен
...
и очень маленькие (древне-еврейское мгновение *регаим* 5/114 секунды);
